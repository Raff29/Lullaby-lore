"""
Django settings for lullabylore project.
...
SECRET_KEY = 'django-insecure-%xya92x!(!^w@zla^4ns&=$lzw=m(ppv(e4_w-dkz51asx_$+o'
...
WSGI_APPLICATION = 'lullabylore.wsgi.application'
